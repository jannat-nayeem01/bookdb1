...
class ReadersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reader" do
    assert_difference("Reader.count") do
      post readers_url, params: { reader: { book_id: @reader.book_id, comments: @reader.comments, readername: @reader.readername } }
    end
  ...
  test "should update reader" do
    patch reader_url(@reader), params: { reader: { book_id: @reader.book_id, comments: @reader.comments, readername: @reader.readername } }
